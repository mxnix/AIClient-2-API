...
> - **2025.12.11** - Docker 镜像自动构建并发布到 Docker Hub: [nikzmx/aiclient-2-api](https://hub.docker.com/r/nikzmx/aiclient-2-api)
...
- [💡 核心优势](#-核心优势)
- [🚀 快速启动](#-快速启动)
  - [🐳 Docker 部署](https://hub.docker.com/r/nikzmx/aiclient-2-api)
  - [📋 核心功能](#-核心功能)
- [🔐 授权配置指南](#-授权配置指南)
- [📁 授权文件存储路径](#-授权文件存储路径)
- [⚙️ 高级配置](#高级配置)
...
```bash
docker run -d -p 3000:3000 -p 8085-8087:8085-8087 -p 1455:1455 -p 19876-19880:19876-19880 --restart=always -v "指定路径:/app/configs" --name aiclient2api nikzmx/aiclient-2-api
```
...
1. 注释掉 `image: nikzmx/aiclient-2-api:latest` 行
2. 取消 `build:` 部分的注释
...
- **重新拉取镜像**：`docker pull nikzmx/aiclient-2-api:latest`
